...
function Hero({ setOpen, banner }: any) {
    ...
    return (
        <div className='relative'>
            <div style={{background: 'linear-gradient(90deg, #c1f2f4 2.34%, #75c1f2 100.78%)'}} className="w-full 1000px:flex items-center bg-[#c1f2f4] 1000px:pt-10">
                ...
                <div className="pt-50 1000px:w-[60%]  justify-center md:justify-start flex flex-col items-center 1000px:mt-[0px] text-center 1000px:text-left min-h-[70vh]">
                    ...
                    ยกระดับความสามารถของตนเองกับเรา <p className='text-[#4092cc] underline'>QKRun.com</p>
                    </h2>
                    <br />
